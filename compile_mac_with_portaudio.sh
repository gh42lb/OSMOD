...
gcc  -Wall -fPIC -Wno-deprecated -Wno-deprecated-declarations -c osmod_audio.c 
...
gcc  -shared -lportaudio -o lb28_compiled_darwin_arm64.so osmod_c_code.o osmod_audio.o
